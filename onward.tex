...
This essay uses the idea of MDD (Mutation Driven Development) as a point of departure from which to explore weaknesses in the motivation, dissemenation, and evaluation of software engineering research, as a result of well-intentioned quality gatekeeping (and less laudable barriers between ``lanes'' of software engineering research styles).
  \end{abstract}
