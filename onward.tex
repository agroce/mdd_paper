...
satisfying what reviewers wanted from the version you read here; put
...
\emph{and the Postscript} talks about the core issue that I think is
important to talk about here, and that (more importantly, for
publication purpsoes) the reviewers wanted to see more about.
...
conditoins required substantial
re-writing or experimental effort, it has always been very obvious what
